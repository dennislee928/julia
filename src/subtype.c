...
static int subtype_ccheck_(jl_value_t *x, jl_value_t *y, jl_stenv_t *e, int chain_relative)
{
...
static int subtype_ccheck_frames(jl_value_t *x, jl_varbinding_t *xframe,
                                 jl_value_t *y, jl_varbinding_t *yframe, jl_stenv_t *e)
{
...
static int check_vararg_length(jl_value_t *v, ssize_t n, jl_stenv_t *e, jl_varbinding_t *frame)
{
...
static int equal_var_(jl_tvar_t *v, jl_varbinding_t *vb, int innervar, jl_value_t *x, jl_stenv_t *e)
{
    assert(e->Loffset == 0);
...
static jl_value_t *widen_diagonal(jl_value_t *t, jl_unionall_t *u, jl_varbinding_t *troot,
                                  jl_svec_t *outervars, size_t nouter)
{
